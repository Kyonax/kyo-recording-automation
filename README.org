...
<a href="#"><img src="https://img.shields.io/badge/license-MPL--2.0-blue" alt="MPL-2.0"></a>
<a href="#"><img src="https://img.shields.io/badge/license-Apache--2.0-blue" alt="Apache-2.0"></a>
<a href="#"><img src="https://img.shields.io/badge/version-v0.1-FFD700?labelColor=000000" alt="v0.1"></a>
...
** PROJECT FILEs
- [[file:LICENSE][LICENSE]] / [[file:LICENSE-APACHE][LICENSE-APACHE]] — dual-licensed MPL-2.0 + Apache-2.0 (see [[file:LICENSING.org][LICENSING.org]] for per-file guide)
- [[file:NOTICE][NOTICE]] — attribution, must travel with all redistributions
- [[file:CHANGELOG.org][CHANGELOG.org]] — version history
- [[file:eslint.config.mjs][eslint.config.mjs]] — code style based on [[https://github.com/ccs-devhub][CCS]] standards
- [[file:.github/SECURITY.org][.github/SECURITY.org]] — banned patterns and enforcement
- [[file:.github/CODEOWNERS][.github/CODEOWNERS]] — all changes require review from =@Kyonax=
